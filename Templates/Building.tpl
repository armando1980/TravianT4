...
<div class="boxes-contents">
            ...
            <div class="finishNow"><a class="arrow" href="?cmd=buildingFinish" onclick="return confirm('Építések és fejlesztések azonnali befejezése 2 aranyba került.');">Építések azonnali befejezése</a>
             <b>2</b> <img src="img/x.gif" class="gold" alt="Arany"></div>
		<?php
            }
            ?></th>
		</tr></thead>
        ...
        foreach($building->buildArray as $jobs) {
			...
			echo $building->procResType($jobs['type'])." <span class=\"lvl\"> Szint ".($village->resarray['f'.$jobs['field']]+($jobs['field']==$BuildFirst?2:1 ))."</span>";
            ...
            echo "</span> óra. ";
            echo "Kész: ".date('H:i', $jobs['timestamp'])."</td></tr>";
            $timer +=1;
      	}
        ?>
            </tbody>
