...
<div id="attributes"><div class="boxes boxesColor gray"><div class="boxes-tl"></div><div class="boxes-tr"></div><div class="boxes-tc"></div><div class="boxes-ml"></div><div class="boxes-mr"></div><div class="boxes-mc"></div><div class="boxes-bl"></div><div class="boxes-br"></div><div class="boxes-bc"></div><div class="boxes-contents">
  ...
  <div class="attribute power tooltip" title="قدرت هجومی||قدرت هجومی قهرمان ترکیبی از قدرت حمله و دفاع او می‌باشد. به هر اندازه که قدرت هجومی قهرمان بیشتر باشد به همان اندازه صدمه کمتری در ماجراجویی‌های خود خواهد دید.<br><font color='#5dcbfb'>قدرت هجومی: <?php echo 100+$tp*$hero['power'] ?> از قهرمان</font>">
			<?php }else{ ?>
  <div class="attribute power tooltip" title="قدرت هجومی||قدرت هجومی قهرمان ترکیبی از قدرت حمله و دفاع او می‌باشد. به هر اندازه که قدرت هجومی قهرمان بیشتر باشد به همان اندازه صدمه کمتری در ماجراجویی‌های خود خواهد دید.<br><font color='#5dcbfb'>قدرت هجومی: <?php echo 100+$tp*$hero['power'] ?> از قهرمان + <?php echo $hero['itempower'] ?> از تجهیزات </font>">
			<?php } ?>
		...
		<div class="clear"></div>
  <div class="attribute offBonus tooltip" title="امتیاز هجومی||باعث افزایش قدرت هجومی تمامی لشکریانی خواهد شد که همراه قهرمان می‌باشند.<br><font color='#5dcbfb'>امتیاز هجومی: <?php echo ($hero['offBonus']/5); ?>%</font>">
  ...
  <div class="attribute defBonus tooltip" title="امتیاز دفاعی||باعث افزایش قدرت دفاعی تمامی لشکریانی خواهد شد که همراه قهرمان می‌باشند.<br><font color='#5dcbfb'>امتیاز دفاعی: <?php echo ($hero['defBonus']/5); ?>%</font>">
...
<br><font color='#5dcbfb'>افزایش تولید منابع: <?php if($hero['r0']!=0){echo $rp;}else if($hero['r1']!=0){echo $hero['r1']*10*SPEED;}else if($hero['r2']!=0){echo $hero['r2']*10*SPEED;}else 
if($hero['r3']!=0){echo $hero['r3']*10*SPEED;}else if($hero['r4']!=0){?> <img alt="گندم" class="r4" src="img/x.gif"><? echo $hero['r4']*10*SPEED;}; ?> منبع</font>">
