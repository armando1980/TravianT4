<h1 class="titleInHeader">Csapdakészítő <span class="level">Szint <?php echo $village->resarray['f'.$id]; ?></span></h1>
    ...
    <div class="build_desc">
        ...
        A csapdakészítő jól elrejtett csapdákkal védi a falut. Figyelmetlen ellenség belelépve fogságba eshet és jó darabig nem jelent veszélyt a falura nézve.</div>

<table cellpadding="1" cellspacing="1" id="build_value">
	<tr>
		<th>Csapdák száma jelenlegi szinten:</th>

		<td><b><?php echo $bid36[$village->resarray['f'.$id]]['attri']; ?></b> csapda</td>
	</tr>
	<tr>
    <?php 
        if(!$building->isMax($village->resarray['f'.$id.'t'],$id)) {
        ?>
		<th>Csapdák száma következő (<?php echo $village->resarray['f'.$id]+1; ?>) szinten:</th>
		<td><b><?php echo $bid36[$village->resarray['f'.$id]+1]['attri']; ?></b> csapda</td>
<?php
            }
            ?>
	</tr>
...
<span class="furtherInfo">(Jelenlegi: 0)</span>
</div>
