...
<p><b>Nyersanyag elosztva.</b> Ára: <b>3</b><img src="img/x.gif" class="gold" alt="Arany" title="Arany" /></p>
<a href="javascript: history.go(-2)">Vissza az épülethez</a> 

<?php } else { ?>

<p>Az NPC kereskedőkkel szabadon el tudod osztani a raktáradban a nyersanyagokat. <br><br>Az első sor az aktuális raktárad tartalmát mutatja. A második sorban a te saját nyersanyagelosztásodat láthatod. A harmadik sor a különbséget mutatja az új és a régi raktár tartalom között.</p>
...
<script language="JavaScript">var summe=<?php echo floor($village->awood+$village->acrop+$village->airon+$village->aclay); ?>;var max123=<?php echo $village->maxstore; ?>;var max4=<?php echo $village->maxcrop; ?>;</script> 
		...
		<table id="npc" cellpadding="1" cellspacing="1"> 
			...
			<td class="all"> 
				<a href="javascript:fillup(0);"><img class="r1" src="img/x.gif" alt="Fa" title="Fa" /></a> 
				<span id="org0"><?php echo floor($village->awood); ?></span> 
			</td> 
		
			<td class="all"> 
				<a href="javascript:fillup(1);"><img class="r2" src="img/x.gif" alt="Agyag" title="Agyag" /></a> 
				<span id="org1"><?php echo floor($village->aclay); ?></span> 
			</td> 
		
			<td class="all"> 
				<a href="javascript:fillup(2);"><img class="r3" src="img/x.gif" alt="Vasérc" title="Vasérc" /></a> 
				<span id="org2"><?php echo floor($village->airon); ?></span> 
			</td> 
		
			<td class="all"> 
				<a href="javascript:fillup(3);"><img class="r4" src="img/x.gif" alt="Búza" title="Búza" /></a> 
				<span id="org3"><?php echo floor($village->acrop); ?></span> 
			</td> 
		
				<td class="sum">Összesen:&nbsp;<span id="org4"><?php echo floor($village->awood+$village->acrop+$village->airon+$village->aclay); ?></span></td> 
			</tr> 
		</thead> 
		<tbody> 
			<tr> 
			...
			<td class="sum">Összesen:&nbsp;<span id="newsum"><?php if(isset($_GET['r1']) && isset($_GET['r2']) && isset($_GET['r3']) && isset($_GET['r4'])) { echo $_GET['r1']+$_GET['r2']+$_GET['r3']+$_GET['r4']; } else { echo 0; } ?></span></td> 
		</tr> 
		<tr> 
			...
			<td class="rem"> 
				<span id="diff3"><?php echo 0-floor($village->acrop); ?></span> 
					...
					<td class="sum">Maradék:&nbsp;<span id="remain">
        ...
        <button type="submit" value="(2/2) Nyersanyag elosztása" id="npc_market_button" onclick="$('npc_market_button').addClass('disabled').disabled = true;document.snd.submit();"><div class="button-container"><div class="button-position"><div class="btl"><div class="btr"><div class="btc"></div></div></div><div class="bml"><div class="bmr"><div class="bmc"></div></div></div><div class="bbl"><div class="bbr"><div class="bbc"></div></div></div></div><div class="button-contents">(2/2) Nyersanyag elosztása
</div></div></button><span class="npc_price">(<b>3</b><img src="img/x.gif" class="gold" /> arany)</span></p>
		<?php } else { echo"<a href=\"plus.php\"><span class=\"none\">nincs elég aranyad a cseréhez</span></a>"; }?></p>
		<p id="submitText"></p> 
		</form> 
		<script> 
			calculateRest();
