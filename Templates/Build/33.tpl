<h1 class="titleInHeader">Cölöpfal <span class="level">Szint <?php echo $village->resarray['f'.$id]; ?></span></h1>
    ...
    <div class="build_desc">
        ...
        A cölöpfal építésével könyebben megvédheted magad a támadó barbár hordákkal szemben. Magasabb szint nagyobb védelmi bónuszt ad a védekező csapatoknak. </div>
