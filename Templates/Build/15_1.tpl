...
if($village->resarray['f'.$id] >= DEMOLISH_LEVEL_REQ) {
	echo "<h4>Épületek lebontása:</h4><p>If you do not need another building to give it the destruction of the architecture:</p>";
